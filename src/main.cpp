...
int main(int argc, char* argv[]) {
    ...
    zeroArray(SIZE, c);
    printDesc("work-efficient scanOptimized, power-of-two");
    ...
    zeroArray(SIZE, c);
    printDesc("work-efficient scanOptimized, non-power-of-two");
    ...
    zeroArray(SIZE, c);
    printDesc("work-efficient compactOptimized, power-of-two");
    count = StreamCompaction::Efficient::compactOptimized(SIZE, c, a);
    printElapsedTime(StreamCompaction::Efficient::timer().getGpuElapsedTimeForPreviousOperation(), "(CUDA Measured)");
    //printArray(count, c, true);
    printCmpLenResult(count, expectedCount, b, c);

    zeroArray(SIZE, c);
    printDesc("work-efficient compactOptimized, non-power-of-two");
    count = StreamCompaction::Efficient::compactOptimized(NPOT, c, a);
    printElapsedTime(StreamCompaction::Efficient::timer().getGpuElapsedTimeForPreviousOperation(), "(CUDA Measured)");
    //printArray(count, c, true);
    printCmpLenResult(count, expectedNPOT, b, c);
